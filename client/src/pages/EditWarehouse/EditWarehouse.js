...
export default function EditWarehouse(props) {
  ...
  useEffect(() => {
    axios
      .get(`${apiUrl}/warehouses/${props.match.params.id}`)
      .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(`${apiUrl}/warehouses/${warehouse.id}`, updatedWarehouse)
      .then((response) => {
      ...
      <form onSubmit={handleSubmit} className="editWarehouse__container">
        <div className="editWarehouse__header">
          <span
            ...
            className="editWarehouse__arrow"
          />
        ...
        <div className="editWarehouse__actions">
          ...
          <button type="submit" className="editWarehouse__actions--save">
            Save
          </button>
        </div>
      </form>
