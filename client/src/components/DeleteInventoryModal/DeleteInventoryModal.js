    ...
    <div className={showHideClassName}>
      <section className="modal-box">
        ...
        <div className="modal-main">
          <h1 className="modal-main__header">{`Delete ${inventory.itemName} inventory item?`}</h1>
          <p className="modal-main__text">
            {`Please confirm that you'd like to delete ${inventory.itemName} from the inventory list
